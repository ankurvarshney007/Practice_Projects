...
public class Main {
	...
	public static void main(String[] args) {
		...
		do {
			...
			// Method call for calculating tax calculation for different items 
			 item1.taxRate();
		
			if(item1.getSalesTax()!=0) {
		...
		// Item Price , ItemName , sales tax and final cost of different items. output section
			for(Item t : item) {
				...
				System.out.println("ItemName = " + t.getItemName() + " , " + "ItemPrice = " + t.getItemPrice() + " , " +  "sales tax per item = " + t.getSalesTax() + " , " + "finalCost = " +  t.getFinalCost());
